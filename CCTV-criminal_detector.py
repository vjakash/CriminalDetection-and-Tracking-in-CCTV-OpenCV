...
def sendsms(msg):
    ...
    payload = "sender_id=FSTSMS&message="+msg+"&language=english&route=p&numbers=8870631234,"
    headers = {
...
cam3="http://192.168.1.4:7070/shot.jpg"
cam1="http://192.168.1.8:7070/shot.jpg"
cam2="http://192.168.1.6:7070/shot.jpg"
cam=[cam1,cam2,cam3]
graph={cam1:[cam2,cam3],cam2:[cam3],cam3:[]}
...
while True:
    ...
    '''(_, im) = cam1.read()'''
    imgPath=urllib.request.urlopen(cam1)
